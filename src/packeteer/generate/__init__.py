...
from .dhcp import (
    ...
    DHCP_OP_REQUEST, DHCP_OP_REPLY,
    DHCP_MSG_DISCOVER, DHCP_MSG_OFFER, DHCP_MSG_REQUEST, DHCP_MSG_DECLINE,
    DHCP_MSG_ACK, DHCP_MSG_NAK, DHCP_MSG_RELEASE, DHCP_MSG_INFORM,
    DHCP_OPT_SUBNET_MASK, DHCP_OPT_ROUTER, DHCP_OPT_DNS_SERVER,
    DHCP_OPT_HOSTNAME, DHCP_OPT_DOMAIN_NAME, DHCP_OPT_REQUESTED_IP,
