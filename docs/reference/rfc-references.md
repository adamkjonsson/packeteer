...
* - [RFC 3849](https://datatracker.ietf.org/doc/html/rfc3849)
  ...
  - Synthetic IPv6 addresses used by `packeteer.sanitiser.sanitise` (2001:db8::/32)
...
* - [RFC 5737](https://datatracker.ietf.org/doc/html/rfc5737)
  ...
  - Synthetic IPv4 addresses used by `packeteer.sanitiser.sanitise` (192.0.2.0/24, 198.51.100.0/24, 203.0.113.0/24)
