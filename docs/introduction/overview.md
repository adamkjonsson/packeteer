...
| Tunnelling / encapsulation | MPLS, GRE, EtherIP, IP-in-IP, pseudowire, VXLAN |
| Network | IPv4, IPv6 |
...
IP-in-IP, pseudowire, VXLAN) to match the encapsulation stack of the network under test.  The
