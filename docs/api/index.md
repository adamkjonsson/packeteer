...
decodes them back to header dataclasses or JSON config; `replacer` sanitises
...
packet sequences that can be written directly to pcap, pcapng, or JSON config.
...
to the JSON config dict format.
